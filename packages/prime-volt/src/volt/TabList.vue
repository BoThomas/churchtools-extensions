...
const theme = ref<TabListPassThroughOptions>({
  ...
  // Thicker active bar to match enlarged tabs
  activeBar: `z-10 block absolute -bottom-px h-[2px] bg-primary transition-[left] duration-300 ease-[cubic-bezier(0.35,0,0.25,1)] origin-center scale-x-80`,
});
</script>
