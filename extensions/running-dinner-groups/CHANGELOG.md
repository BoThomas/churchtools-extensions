...
## 2026-02-06 — ct-running-dinner-groups v1.0.2
...
**Full Changelog**: https://github.com/BoThomas/churchtools-extensions/compare/2025-12-06-ct-running-dinner-groups-v1.0.1...2026-02-06-ct-running-dinner-groups-v1.0.2
...
- c04227f feat: update plans/docs for dessert at after party
- 70d0ce4 feat: implement dessert at after party refactor
- ca4f9df feat: refactor dessert routing and email notifications for after party setup
- 895c486 style: fix layout and styling for search input and empty states in DinnerGroupBuilder, MemberList, and RouteAssignment components when run inside CT
...
- 7c74966 chore(running-dinner-groups): remove unnecessary blank line in .env file
- b83b252 chore(running-dinner-groups): release v1.0.1
...
**Full Changelog**: https://github.com/BoThomas/churchtools-extensions/commits/2025-12-06-ct-running-dinner-groups-v1.0.0
