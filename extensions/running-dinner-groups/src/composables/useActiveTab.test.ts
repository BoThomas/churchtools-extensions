...
const VALID_TABS = ['settings', 'organize'] as const;
...
describe('useActiveTab', () => {
  ...
  describe('initialization', () => {
    it('should return default tab when localStorage is empty', () => {
      const activeTab = useActiveTab('test-ext', 'organize', VALID_TABS);
      expect(activeTab.value).toBe('organize');
    });
    ...
    it('should use the correct storage key format', () => {
      useActiveTab('my-extension', 'organize', VALID_TABS);
